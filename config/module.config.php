...
return array(
      'acl' => array(
        'Diretoria' => array(
            'DIRETORIA' => array(
                'Diretoria\Controller\Index:index',              
            ),
            'TI' => array(
                'Diretoria\Controller\Index:index',              
            ),
        ...
        'routes' => array(
            ...
            'diretoria' => array(
                ...
                'options' => array(
                    'route' => '/diretoria',
                    'defaults' => array(
                       // '__NAMESPACE__' => 'Diretoria\Controller',
                        'controller' => 'Diretoria\Controller\Index',
                        'action' => 'index',
                    ),
                ),
            ),
    ...
    'controllers' => array(
        'invokables' => array(
            'Diretoria\Controller\Index' => 'Diretoria\Controller\IndexController'
        ),
    ),
    'view_manager' => array(
